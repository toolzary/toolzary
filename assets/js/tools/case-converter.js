    ...
    app.innerHTML = `
        ...
        <div class="tool-custom-interface">
          ...
          <div class="form-group">
            ...
            <textarea id="textInput" class="data-input-field textarea-input" rows="6" placeholder="Type or paste your text here"></textarea>
          </div>

          <!-- Case Buttons -->
          <div class="case-button-group">
  <button class="first-btn case-btn" data-case="uppercase">UPPER CASE</button>
  <button class="first-btn case-btn" data-case="lowercase">lower case</button>
  <button class="first-btn case-btn" data-case="titlecase">Title Case</button>
  <button class="first-btn case-btn" data-case="sentencecase">Sentence case</button>
  <button class="first-btn case-btn" data-case="capitalize">Capitalize</button>
  <button class="first-btn case-btn" data-case="alternating">aLtErNaTiNg</button>
</div>
          ...
          <div class="action-button-group">
            ...
            <button id="copyBtn" class="first-btn">Copy Result</button>
          </div>

          <!-- Result -->
          <div id="caseResultBox" class="result-box-card hidden">
            <h3 class="result-box-title">Converted Text</h3>
            <div id="convertedOutput" class="converted-output"></div>
          </div>
    ...
    */
    ...
    console.log(
      '[Case Converter] Tool initialized successfully.'
    );
